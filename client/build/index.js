...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calendars = __webpack_require__(197);
	
	var _calendars2 = _interopRequireDefault(_calendars);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var gcApp = (0, _redux.combineReducers)({
	  auth: _auth2.default,
	  calendars: _calendars2.default
	});
	
	exports.default = gcApp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    ...
	    case _auth.RECEIVE_AUTH_RESULT:
	      return Object.assign({}, state, {
	        isFetching: false,
	        data: action.data
	      });
...
/***/ function(module, exports) {
	...
	var RECEIVE_AUTH_RESULT = exports.RECEIVE_AUTH_RESULT = 'RECEIVE_AUTH_RESULT';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LS_KEY_CLIENT_ID = 'AUTH_CLIENT_ID';
	var LS_KEY_API_KEY = 'AUTH_API_KEY';
	
	var Auth = function Auth(_ref) {
	  var dispatch = _ref.dispatch;
	
	  var refInputClientId = void 0;
	  var refInputApiKey = void 0;
	  var clientId = localStorage.getItem(LS_KEY_CLIENT_ID) || '';
	  var apiKey = localStorage.getItem(LS_KEY_API_KEY) || '';
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { ref: function ref(node) {
	          refInputClientId = node;refInputClientId.value = clientId;
	        } })
	    ),
	    _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement('input', { ref: function ref(node) {
	          refInputApiKey = node;refInputApiKey.value = apiKey;
	        } })
	    ),
	    _react2.default.createElement(
	      'div',
	      ...
	      _react2.default.createElement(
	        ...
	        { onClick: function onClick(e) {
	            ...
	            dispatch((0, _auth2.default)(clientId, apiKey));
	          } },
	        'Auth'
	      )
	    )
	...
	Auth = (0, _reactRedux.connect)()(Auth);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function receiveAuthResult(data) {
	  console.log(data);
	  return {
	    type: _auth.RECEIVE_AUTH_RESULT,
	    data: data
	  };
	}
